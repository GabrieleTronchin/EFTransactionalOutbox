...
- [x] 1. Enrich ProductEntity with catalog properties
  - [x] 1.1 Update `ProductEntity` with new properties and factory method
  ...
  - [x] 1.2 Update `ProductConfiguration` for new properties
    - Configure `Name`, `Price`, `Sku` as required properties
    - Configure `Description` as nullable
    - _Requirements: 1.1_

  - [x] 1.3 Update `ProductEntityTests` for enriched factory method
...
- [x] 2. Enrich OrderEntity with marketplace order properties
  - [x] 2.1 Create `OrderStatus` enum and `OrderCancelled` domain event
  ...
  - [x] 2.2 Update `OrderEntity` with new properties and lifecycle methods
  ...
  - [x] 2.3 Update `OrderConfiguration` for new properties
  ...
  - [x] 2.4 Update `OrderConfirmed` event to include `OrderId`
  ...
  - [x] 2.5 Update `OrderEntityTests` for enriched entity
...
- [x] 3. Checkpoint — Ensure domain layer compiles and tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Implement InboxMessageEntity and persistence
  - [x] 4.1 Create `InboxMessageEntity` in the Domain layer
  ...
  - [x] 4.2 Add `InboxMessageEntity` to persistence layer
  ...
  - [x] 4.3 Update `OrderDomainEventInterceptorTests` for enriched OrderEntity
...
- [x] 5. Update seed data with realistic marketplace products and orders
  - [x] 5.1 Update `SeedDb` with enriched seed data
...
- [ ] 6. Implement InboxMessageProcessorJob
  - [x] 6.1 Create `InboxMessageProcessorJob` in the API `Job/` folder
...
- [x] 7. Checkpoint — Ensure inbox pattern compiles and tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Implement new and updated API endpoints
  - [x] 8.1 Add `GET /Products/{id}` endpoint
  ...
  - [x] 8.2 Add `POST /Orders/{id}/Cancel` endpoint
  ...
  - [x] 8.3 Add `POST /Inbox/Receive` endpoint
  ...
  - [x] 8.4 Update existing `POST /PurchaseOrder/{id}` endpoint
  ...
  - [x] 8.5 Add Swagger annotations to existing `GET /Products` and `GET /Orders` endpoints
...
- [x] 9. Update .http file with all endpoints
  - [x] 9.1 Update `Sample.TransactionalOutbox.http` with all API endpoints
...
- [x] 10. Checkpoint — Ensure full solution builds and all tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 11. Update README and documentation
  - [x] 11.1 Update `README.md` for marketplace Orders microservice
  ...
  - [x] 11.2 Create Transactional Inbox documentation in `docs/`
  ...
  - [x] 11.3 Update existing docs for enriched domain model
